...
@njit()
def _no_capture_condition(ar, ac, old_ar, old_ac, y, x):
    return _is_action_impact(ar, ac, y, x) or _is_action_impact(old_ar, old_ac, y, x)

@njit()
def _capture_condition(ar, ac, old_ar, old_ac, y, x):
    return True
